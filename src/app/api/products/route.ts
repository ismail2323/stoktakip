  ...
  try {
    const urun = await prisma.urun.create({
      data: {
        ...
        miktar: Number(body.miktar) || 0,
        minStokSeviyesi: Number(body.minStokSeviyesi) || 1,
        birim: body.birim || "adet",
        alisFiyati: body.alisFiyati != null ? Number(body.alisFiyati) : null,
        satisFiyati: body.satisFiyati != null ? Number(body.satisFiyati) : null,
